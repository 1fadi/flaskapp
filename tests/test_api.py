...
class ApiTestCase(unittest.TestCase):
    ...
    def test_404(self):
        response = self.client.get('/wroneg/url',
    ...
    def test_bad_auth(self):
        ...
        # authinticate with bad password
    ...
    def test_posts(self):
        ...
        response = self.client.post(
            '/api/v1/posts/',
            headers=self.get_api_headers('john@example.com', 'cat'),
            data=json.dumps({'title': 'This is a title', 'body': 'body of the *blog* post'}))
    ...
    def test_comments(self):
        ...
        # add a post
        post = Post(title='this is a title', body='body of the post', author=u1)
        db.session.add(post)
        db.session.commit()
